...
!(function() {
    ...
    var R = T[d],
        ...
        F = !1;
    m &&
        ((F = (c.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
                c.readyState
            )) ||
            c.addEventListener("DOMContentLoaded", function t() {
    ...
    var Q = { x: 0, y: 0, width: "100%", height: "100%" },
        Z = function(t) {
            var e = t.children,
                ...
                m = {
                    ...
                    children: [{
                        tag: "path",
                        attributes: O({}, s.attributes, c.path, { fill: "black" }),
                    }, ],
                },
                ...
                e.push({
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            attributes: O({}, i.icon.attributes, o.path),
                        }, ],
                    }, ],
                });
            } else e.push(i.icon);
        ...
        et = function(t) {
            ...
            return [{
                ...
                children: [
                    { tag: "symbol", attributes: O({}, r, { id: o }), children: i },
                ],
            }, ];
        };
    ...
    function nt(t) {
        var e = t.icons,
            ...
            p = [S.replacementClass, a ? S.familyPrefix + "-" + a : "", h]
            .concat(l.classes)
            .join(" "),
            v = {
                children: [],
        ...
        u && (v.attributes[C] = ""),
            ...
            v.children.push({
                tag: "title",
                attributes: { id: v.attributes["aria-labelledby"] || "title-" + X() },
                children: [f],
            });
        var b = O({}, v, {
                prefix: r,
    ...
    function it(t) {
        ...
        G(r) &&
            ((y.transform =
                    ((u = (c = { transform: r, startCentered: !0, width: n, height: i })
                            .transform),
                        (m = c.width),
                        (d = void 0 === m ? z : m),
                        (g = c.height),
                        ...
                        (b +=
                            ...
                            u.y / _ +
                            "em)) " :
                            "translate(" + u.x / _ + "em, " + u.y / _ + "em) "),
                        (b +=
                            "scale(" +
                            (u.size / _) * (u.flipX ? -1 : 1) +
                            ", " +
                            (u.size / _) * (u.flipY ? -1 : 1) +
                            ") "),
    ...
    var rt = function() {},
        at =
        S.measurePerformance && l && l.mark && l.measure ?
        l : { mark: rt, measure: rt },
        ot = 'FA "5.0.13"',
        st = function(t) {
            at.mark(ot + " " + t + " ends"),
                at.measure(
        ...
        lt = function(t, e, n, i) {
            var r,
                ...
                ((s = e),
                    (f = i),
                    function(t, e, n, i) {
                        return s.call(f, t, e, n, i);
                    }) :
                e;
            for (
                void 0 === n ? ((r = 1), (o = t[l[0]])) : ((r = 0), (o = n)); r < c; r++
            )
                o = u(o, t[(a = l[r])], a, t);
            return o;
        },
    ...
    function bt(t) {
        return t.reduce(function(t, e) {
            ...
            if (pt[e]) t.prefix = e;
                ...
                var i =
                    "fa" === t.prefix ? gt[n] || { prefix: null, iconName: null } : {};
                (t.iconName = i.iconName || n), (t.prefix = i.prefix || t.prefix);
            } else
                e !== S.replacementClass && 0 !== e.indexOf("fa-w-") && t.rest.push(e);
            return t;
        }, vt());
    }
    ...
    function Ct(n, t) {
        ...
        0 === n.length ?
            ...
            (
                ...
                var t = !0 === S.autoReplaceSvg ?
                    zt.replace :
                    zt[S.autoReplaceSvg] || zt.replace,
                    e = ft.begin("mutate");
                n.map(t), e(), i();
            });
    }
    ...
    var Mt = function(t) {
            ...
            return (
                ...
                f.prefix && 1 < s.length ?
                (f.iconName = ((i = f.prefix), (r = t.innerText), dt[i][r])) :
                f.prefix &&
                1 === s.length &&
                (f.iconName =
                    ((e = f.prefix),
        ...
        St = function(t) {
            ...
            return (
                S.autoA11y &&
                (n ?
                    (e["aria-labelledby"] = S.replacementClass + "-title-" + X()) :
                    (e["aria-hidden"] = "true")),
                e
            );
        },
    ...
    var Rt = { fill: "currentColor" },
        ...
        _t = {
            ...
            children: [
                ...
                {
                    tag: "circle",
                    attributes: O({}, Rt, { cx: "256", cy: "364", r: "28" }),
                    children: [{
                            tag: "animate",
                            attributes: O({}, Ht, {
                                attributeName: "r",
                        ...
                        {
                            tag: "animate",
                            attributes: O({}, It, { values: "1;0;1;1;0;1;" }),
                        },
                    ],
                },
                {
                    ...
                    children: [{
                        tag: "animate",
                        attributes: O({}, It, { values: "1;0;0;0;0;1;" }),
                    }, ],
                },
                {
                    tag: "path",
                    ...
                    children: [{
                        tag: "animate",
                        attributes: O({}, It, { values: "0;0;1;1;0;0;" }),
                    }, ],
                },
            ],
        },
    ...
    function Yt(t, e) {
        ...
        if (t && e && Bt[e] && Bt[e][t]) {
            ...
            throw new Tt("Icon is missing for prefix " + e + " with icon name " + t);
        return n;
    }
    ...
    function Ut(t) {
        ...
        return ~w.extra.classes.indexOf(Dt) ?
            (function(t, e) {
                var n = e.title,
                    i = e.transform,
                    r = e.extra,
            ...
            ((u = t),
                ...
                (y = m.extra), [
                    u,
                    nt({
                        icons: { main: Yt(d, h), mask: Yt(b.iconName, b.prefix) },
                        prefix: h,
                        iconName: d,
                        transform: p,
                        symbol: v,
                ...
                Y(t.querySelectorAll("*")).forEach(function(o) {
                    [":before", ":after"].forEach(function(e) {
                        ...
                        if (
                            (i &&
                                (i.nextSibling &&
                                    -1 < i.nextSibling.textContent.indexOf(h) &&
                                    Vt(i.nextSibling),
                                    Vt(i),
                                    (i = null)),
                                n && !i)
    ...
    var Qt = (function() {
        ...
        return (
            A(t, [{
                    ...
                    value: function() {
                        for (
                            var e = this, t = arguments.length, n = Array(t), i = 0; i < t; i++
                        )
                            n[i] = arguments[i];
    ...
    var ie,
        ...
        ((ie = function(t) {
                ...
                if (t) {
                    var p = t.prefix,
                        v = t.iconName,
                        b = t.icon;
                    return ee(O({ type: "icon" }, t), function() {
                        return (
                            te(),
                            S.autoA11y &&
                            (l ?
                                (d["aria-labelledby"] =
                                    S.replacementClass + "-title-" + X()) :
                                (d["aria-hidden"] = "true")),
                            nt({
                                icons: {
                                    main: Zt(b),
                                    mask: s ?
                                        Zt(s.icon) : { found: !1, width: null, height: null, icon: {} },
                                },
                                prefix: p,
                                iconName: v,
                                transform: O({}, B, i),
                    ...
                    return (
                        ...
                        it({
                            ...
                            extra: {
                                attributes: l,
                                styles: u,
                                classes: [S.familyPrefix + "-layers-text"].concat(M(s)),
                            },
                        })
                    );
                });
        ...
        se = function() {
            m && S.autoReplaceSvg && oe.dom.i2svg({ node: c });
        };
    Object.defineProperty(oe, "config", {
        ...
        (function(t) {
            ...
            u &&
                (s.FontAwesome || (s.FontAwesome = oe),
                    I(function() {
                        0 < Object.keys(R.styles).length && se(),
                            S.observeMutations &&
                            ...
                            (function(t) {
                                if (f) {
                                    ...
                                    m &&
                                        At.observe(c.getElementsByTagName("body")[0], {
                                            childList: !0,
                                            attributes: !0,
                                            characterData: !0,
                                            subtree: !0,
                ...
                (R.hooks = O({}, R.hooks, {
                    addPack: function(t, e) {
                        (R.styles[t] = O({}, R.styles[t] || {}, e)), ht(), se();
                    },
                    addShims: function(t) {
                        var e;
