<div class="modal fade" id="modal_show_reporting" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="row"  style="padding-left:30px;">
              ...
              <div class="form-group row col-sm-3" style="font-size: 1.4em;">
                  <label class="col-sm-4" style="padding-top: 5px;">Paramétrage :</label>
                  <select id="parametrage" class="form-control col-sm-8"> 
                    <option value="0">Tous</option>
                  </select>
              </div>
              <div class="form-group row col-sm-3" style="font-size: 1.4em;">
                <label class="col-sm-4" style="padding-top: 5px;">Date :</label>
                <select id="date_saisi_reporting-reporting" class="form-control col-sm-6"> 
              ...
              <div class="col-sm-1" id="date1-reporting">
                  <input type="text" id="date_1-reporting" class="form-control date_saisi" readonly>
              </div>
              <div class="col-sm-1" id="date2-reporting" >
                  <input type="text" id="date_2-reporting" class="form-control date_saisi" readonly>
              </div>
              <div>
                  <button type="button" class="btn btn-info form-control btn-search_date" data-mod="reporting-rep" >
